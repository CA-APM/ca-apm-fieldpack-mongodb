...
public class StandaloneMongod extends Topology {

    public StandaloneMongod(
        final Properties props,
        final String h,
        final int p,
        final Logger l
    ) {
        super(props, h, p, l, ClusterType.STANDALONE);
    }

    public void discoverServers(final String nodeType) throws Exception {
        members.add(String.format("%s:%d", dbHost, dbPort));
    }
}
